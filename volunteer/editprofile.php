...
<body>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" id="dob" class="form-control" placeholder="Date of Birth" name="dob" value="<?php echo $_SESSION['dateofbirth']?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="occupation" class="form-control" placeholder="Occupation" name="occupation"  value="<?php echo $_SESSION['occupation']?>" required>
                                                </div>
                                            </div>
    ...
    <script src="../assets/js/editprofilevol.js"></script>
